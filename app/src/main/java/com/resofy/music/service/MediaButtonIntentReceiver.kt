...
import com.resofy.music.service.MusicService.Companion.ACTION_PAUSE
import com.resofy.music.service.MusicService.Companion.ACTION_PLAY
import com.resofy.music.service.MusicService.Companion.ACTION_REWIND
import com.resofy.music.service.MusicService.Companion.ACTION_SKIP
import com.resofy.music.service.MusicService.Companion.ACTION_STOP
import com.resofy.music.service.MusicService.Companion.ACTION_TOGGLE_PAUSE
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "ResofyApp:Wakelock headset button"
                )
