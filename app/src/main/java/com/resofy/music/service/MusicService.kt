 ...
 */
package com.resofy.music.service
...
import com.resofy.music.BuildConfig
...
import com.resofy.music.activities.LockScreenActivity
import com.resofy.music.appwidgets.AppWidgetBig
import com.resofy.music.appwidgets.AppWidgetCard
import com.resofy.music.appwidgets.AppWidgetCircle
import com.resofy.music.appwidgets.AppWidgetClassic
import com.resofy.music.appwidgets.AppWidgetMD3
import com.resofy.music.appwidgets.AppWidgetSmall
import com.resofy.music.appwidgets.AppWidgetText
import com.resofy.music.auto.AutoMediaIDHelper
import com.resofy.music.auto.AutoMusicProvider
import com.resofy.music.extensions.showToast
import com.resofy.music.extensions.toMediaSessionQueue
import com.resofy.music.extensions.uri
import com.resofy.music.glide.BlurTransformation
import com.resofy.music.glide.RetroGlideExtension.getSongModel
import com.resofy.music.glide.RetroGlideExtension.songCoverOptions
import com.resofy.music.helper.ShuffleHelper.makeShuffleList
import com.resofy.music.model.Song
import com.resofy.music.model.Song.Companion.emptySong
import com.resofy.music.model.smartplaylist.AbsSmartPlaylist
import com.resofy.music.providers.HistoryStore
import com.resofy.music.providers.MusicPlaybackQueueStore
import com.resofy.music.providers.SongPlayCountStore
import com.resofy.music.service.notification.PlayingNotification
import com.resofy.music.service.playback.Playback
import com.resofy.music.service.playback.Playback.PlaybackCallbacks
import com.resofy.music.util.MusicUtil
import com.resofy.music.util.MusicUtil.toggleFavorite
import com.resofy.music.util.PackageValidator
import com.resofy.music.util.PreferenceUtil.crossFadeDuration
import com.resofy.music.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.resofy.music.util.PreferenceUtil.isBluetoothSpeaker
import com.resofy.music.util.PreferenceUtil.isBlurredAlbumArt
import com.resofy.music.util.PreferenceUtil.isHeadsetPlugged
import com.resofy.music.util.PreferenceUtil.isLockScreen
import com.resofy.music.util.PreferenceUtil.isPauseOnZeroVolume
import com.resofy.music.util.PreferenceUtil.playbackPitch
import com.resofy.music.util.PreferenceUtil.playbackSpeed
import com.resofy.music.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.resofy.music.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import com.resofy.music.volume.AudioVolumeObserver
import com.resofy.music.volume.OnAudioVolumeChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "com.resofy.music"
