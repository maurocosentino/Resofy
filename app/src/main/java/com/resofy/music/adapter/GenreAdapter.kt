...
import com.resofy.music.databinding.ItemGenreBinding
...
import com.resofy.music.interfaces.IGenreClickListener
...
class GenreAdapter(
    ...
    private fun loadGenreImage(genre: Genre, holder: GenreAdapter.ViewHolder) {
        ...
        Glide.with(activity)
            ...
            .into(object : ResofyColoredTarget(holder.binding.image) {
