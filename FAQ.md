## **Q: How do I get the beta version of Resofy?**
You can opt-in for the beta build by clicking on this link: https://play.google.com/apps/testing/music

___

## **Q: How to restore my purchases?**
Make sure to switch and use your account in the Play Store app through which you purchased before installing Resofy. The Google account used to install the app is also used to purchase/restore the pro license.
...
There are three methods for adding offline synced lyrics in Resofy.
...
Settings -> Personalize -> Fullscreen controls -> Enable (this will only be visible when songs are playing from Resofy).
___
...
Resofy uses the native media player that comes with your Android phone, so as long as a file type is supported by your phone, it's supported by Resofy.
___

## **Q: Why is my device slowing down when I'm using the app?**
Resofy is image intensive, it keeps images in the cache for quick loading.
___

## **Q: The title "Resofy" is showing on the top of the app, how can I fix this?** 
...
1. Then open the Resofy app and manually scan your music from your storage. 

1. Reboot the device to refresh the media store (Not sure if this is necessary)

**NOTE:** Don't panic when you will open Resofy and see "Zero" songs there in the library. It's because you cleared Media Store which is responsible for recognising files on your device.
___
...
- Resofy's font has now been replaced with system font, which means the default font your system uses will be used by Resofy too. It fixes all font-related issues you used to face/are facing in the app. 

- With the recent Resofy v5 release, we have a built-in optional font "Manrope font" which you can toggle from Settings > Look & Feel > Toggle "Use manrope font".
...
Resofy will automatically detect any playlist file when that playlist file is stored in internal storage/Playlist. However, if it doesn't, just open any "File manager" and open that playlist file with Resofy.
