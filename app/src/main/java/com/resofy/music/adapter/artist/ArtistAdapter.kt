 ...
 *
 */
package com.resofy.music.adapter.artist
...
import com.resofy.music.adapter.base.AbsMultiSelectAdapter
import com.resofy.music.adapter.base.MediaEntryViewHolder
...
import com.resofy.music.glide.ResofyColoredTarget
import com.resofy.music.helper.menu.SongsMenuHelper
import com.resofy.music.interfaces.IAlbumArtistClickListener
...
class ArtistAdapter(
    ...
    private fun loadArtistImage(artist: Artist, holder: ViewHolder) {
        ...
        Glide.with(activity)
            ...
            .into(object : ResofyColoredTarget(holder.image!!) {
