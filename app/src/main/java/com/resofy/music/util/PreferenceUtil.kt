...
import com.resofy.music.ADAPTIVE_COLOR_APP
import com.resofy.music.ALBUM_ARTISTS_ONLY
import com.resofy.music.ALBUM_ART_ON_LOCK_SCREEN
import com.resofy.music.ALBUM_COVER_STYLE
import com.resofy.music.ALBUM_COVER_TRANSFORM
import com.resofy.music.ALBUM_DETAIL_SONG_SORT_ORDER
import com.resofy.music.ALBUM_GRID_SIZE
import com.resofy.music.ALBUM_GRID_SIZE_LAND
import com.resofy.music.ALBUM_GRID_STYLE
import com.resofy.music.ALBUM_SONG_SORT_ORDER
import com.resofy.music.ALBUM_SORT_ORDER
import com.resofy.music.APPBAR_MODE
import com.resofy.music.ARTIST_ALBUM_SORT_ORDER
import com.resofy.music.ARTIST_DETAIL_SONG_SORT_ORDER
import com.resofy.music.ARTIST_GRID_SIZE
import com.resofy.music.ARTIST_GRID_SIZE_LAND
import com.resofy.music.ARTIST_GRID_STYLE
import com.resofy.music.ARTIST_SONG_SORT_ORDER
import com.resofy.music.ARTIST_SORT_ORDER
import com.resofy.music.AUDIO_FADE_DURATION
import com.resofy.music.AUTO_DOWNLOAD_IMAGES_POLICY
import com.resofy.music.App
import com.resofy.music.BLACK_THEME
import com.resofy.music.BLUETOOTH_PLAYBACK
import com.resofy.music.BLURRED_ALBUM_ART
import com.resofy.music.CAROUSEL_EFFECT
import com.resofy.music.CIRCLE_PLAY_BUTTON
import com.resofy.music.COLORED_APP_SHORTCUTS
import com.resofy.music.CROSS_FADE_DURATION
import com.resofy.music.CUSTOM_FONT
import com.resofy.music.DESATURATED_COLOR
import com.resofy.music.ENABLE_SEARCH_PLAYLIST
import com.resofy.music.EXPAND_NOW_PLAYING_PANEL
import com.resofy.music.EXTRA_SONG_INFO
import com.resofy.music.FILTER_SONG
import com.resofy.music.GENERAL_THEME
import com.resofy.music.GENRE_SORT_ORDER
import com.resofy.music.HOME_ALBUM_GRID_STYLE
import com.resofy.music.HOME_ARTIST_GRID_STYLE
import com.resofy.music.IGNORE_MEDIA_STORE_ARTWORK
import com.resofy.music.INITIALIZED_BLACKLIST
import com.resofy.music.KEEP_SCREEN_ON
import com.resofy.music.LANGUAGE_NAME
import com.resofy.music.LAST_ADDED_CUTOFF
import com.resofy.music.LAST_CHANGELOG_VERSION
import com.resofy.music.LAST_DIRECTORY
import com.resofy.music.LAST_SLEEP_TIMER_VALUE
import com.resofy.music.LAST_USED_TAB
import com.resofy.music.LIBRARY_CATEGORIES
import com.resofy.music.LOCALE_AUTO_STORE_ENABLED
import com.resofy.music.LOCK_SCREEN
import com.resofy.music.LYRICS_OPTIONS
import com.resofy.music.LYRICS_TYPE
import com.resofy.music.MANAGE_AUDIO_FOCUS
import com.resofy.music.MATERIAL_YOU
import com.resofy.music.NEW_BLUR_AMOUNT
import com.resofy.music.NEXT_SLEEP_TIMER_ELAPSED_REALTIME
import com.resofy.music.NOW_PLAYING_SCREEN_ID
import com.resofy.music.PAUSE_HISTORY
import com.resofy.music.PAUSE_ON_ZERO_VOLUME
import com.resofy.music.PLAYBACK_PITCH
import com.resofy.music.PLAYBACK_SPEED
import com.resofy.music.PLAYLIST_GRID_SIZE
import com.resofy.music.PLAYLIST_GRID_SIZE_LAND
import com.resofy.music.PLAYLIST_SORT_ORDER
import com.resofy.music.R
import com.resofy.music.RECENTLY_PLAYED_CUTOFF
import com.resofy.music.REMEMBER_LAST_TAB
import com.resofy.music.SAF_SDCARD_URI
import com.resofy.music.SAVE_LAST_DIRECTORY
import com.resofy.music.SCREEN_ON_LYRICS
import com.resofy.music.SHOW_LYRICS
import com.resofy.music.SHOW_WHEN_LOCKED
import com.resofy.music.SLEEP_TIMER_FINISH_SONG
import com.resofy.music.SNOWFALL
import com.resofy.music.SONG_GRID_SIZE
import com.resofy.music.SONG_GRID_SIZE_LAND
import com.resofy.music.SONG_GRID_STYLE
import com.resofy.music.SONG_SORT_ORDER
import com.resofy.music.START_DIRECTORY
import com.resofy.music.SWIPE_ANYWHERE_NOW_PLAYING
import com.resofy.music.SWIPE_DOWN_DISMISS
import com.resofy.music.TAB_TEXT_MODE
import com.resofy.music.TOGGLE_ADD_CONTROLS
import com.resofy.music.TOGGLE_FULL_SCREEN
import com.resofy.music.TOGGLE_HEADSET
import com.resofy.music.TOGGLE_HOME_BANNER
import com.resofy.music.TOGGLE_SUGGESTIONS
import com.resofy.music.TOGGLE_VOLUME
import com.resofy.music.USER_NAME
import com.resofy.music.WALLPAPER_ACCENT
import com.resofy.music.WHITELIST_MUSIC
import com.resofy.music.extensions.getIntRes
import com.resofy.music.extensions.getStringOrDefault
import com.resofy.music.fragments.AlbumCoverStyle
import com.resofy.music.fragments.GridStyle
import com.resofy.music.fragments.NowPlayingScreen
import com.resofy.music.fragments.folder.FoldersFragment
import com.resofy.music.helper.SortOrder.AlbumSongSortOrder
import com.resofy.music.helper.SortOrder.AlbumSortOrder
import com.resofy.music.helper.SortOrder.ArtistAlbumSortOrder
import com.resofy.music.helper.SortOrder.ArtistSongSortOrder
import com.resofy.music.helper.SortOrder.ArtistSortOrder
import com.resofy.music.helper.SortOrder.GenreSortOrder
import com.resofy.music.helper.SortOrder.PlaylistSortOrder
import com.resofy.music.helper.SortOrder.SongSortOrder
import com.resofy.music.model.CategoryInfo
import com.resofy.music.transform.CascadingPageTransformer
import com.resofy.music.transform.DepthTransformation
import com.resofy.music.transform.HingeTransformation
import com.resofy.music.transform.HorizontalFlipTransformation
import com.resofy.music.transform.NormalPageTransformer
import com.resofy.music.transform.VerticalFlipTransformation
import com.resofy.music.transform.VerticalStackTransformer
import com.resofy.music.util.theme.ThemeMode
import com.resofy.music.views.TopAppBarLayout
